...
public class Fav_Detail_Activity extends AppCompatActivity implements Next_Prev_Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder(Fav_Detail_Activity.this, this.getString(R.string.native_ad))
            ...
            public void onPageSelected(int position) {
                ...
                if (slideCount >= 25) {
                    if (slideCount <= 25 || slideCount >= 32) {
                        ...
                        InterstitialAd.load(Fav_Detail_Activity.this, Fav_Detail_Activity.this.getResources().getString(R.string.interstitial_ad), adRequest, new InterstitialAdLoadCallback() {
                            @Override
                            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                                ...
                                if (slideCount > 50) {
                                    ...
                                    SlideAd_Service.putSLIDE_AD(Fav_Detail_Activity.this, slideCount - 25);
                                }
