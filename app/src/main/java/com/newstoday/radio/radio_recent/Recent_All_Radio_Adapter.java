...
public class Recent_All_Radio_Adapter extends RecyclerView.Adapter<Recent_All_Radio_Adapter.RadioViewHolder> {

    private final Context context;
    private final List<Recent_Radio_Items> radioItems;

    public Recent_All_Radio_Adapter(Context context, List<Recent_Radio_Items> radioItems) {
