...
public class Recent_Detail_Activity extends AppCompatActivity implements Next_Prev_Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder(Recent_Detail_Activity.this, this.getString(R.string.native_ad))
            ...
            public void onPageSelected(int position) {
                ...
                if (slideCount >= 25) {
                    if (slideCount <= 25 || slideCount >= 32) {
                        ...
                        InterstitialAd.load(Recent_Detail_Activity.this, Recent_Detail_Activity.this.getResources().getString(R.string.interstitial_ad), adRequest, new InterstitialAdLoadCallback() {
                            @Override
                            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                                interstitialAd.show(Recent_Detail_Activity.this);
                                if (slideCount > 50) {
                                    SlideAd_Service.putSLIDE_AD(Recent_Detail_Activity.this, 0);
                                } else {
                                    SlideAd_Service.putSLIDE_AD(Recent_Detail_Activity.this, slideCount - 25);
                                }
