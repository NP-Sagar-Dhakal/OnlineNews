...
public class EntryFragment extends SwipeRefreshFragment implements
    ...
    public void inflateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.feed_fragment_entry, container, true);
            ...
            if (mPreferFullText) {
                ...
                if (alreadyMobilized) {
                    ...
                    if (networkInfo != null && networkInfo.getState() == NetworkInfo.State.CONNECTED) {
                        ...
                        activity.runOnUiThread(() -> Toast.makeText(activity, R.string.network_error, Toast.LENGTH_SHORT).show());
        ...
        mCancelFullscreenBtn.setOnClickListener(view -> setImmersiveFullScreen(false));
        ...
        //Init ViewPager dots
        IndefinitePagerIndicator mIndicator = rootView.findViewById(R.id.indicator);
    ...
    public void setData(Uri uri) {
        ...
        mBaseUri = FeedData.EntryColumns.PARENT_URI(Objects.requireNonNull(uri.getPath()));
        try {
    ...
    public void onClickEnclosure() {
        getActivity().runOnUiThread(() -> {
            ...
            new AlertDialog.Builder(getActivity())
                    ...
                    .setPositiveButton(R.string.open_link, (dialog, which) -> showEnclosure(uri, enclosure, position1, position2)).setNegativeButton(R.string.download_and_save, (dialog, which) -> {
                try {
        ...
        void displayEntry(int pagerPos, Cursor newCursor, boolean forceUpdate) {
            ...
            if (view != null) {
                ...
                if (newCursor != null && newCursor.moveToFirst()) {
                    ...
                    view.setHtml(mEntriesIds[pagerPos], title, link, contentText, enclosure, author, timestamp);
