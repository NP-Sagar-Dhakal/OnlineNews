...
import com.newstoday.news_package.recent_news.service.Lollipop_RefreshService;
...
//    Background Service
    ...
    public static void scheduleFeedJob(Context context) {
        ...
        ComponentName serviceComponent = new ComponentName(context, com.newstoday.rssfeedreader.service.Lollipop_RefreshService.class);
        JobInfo builder = new JobInfo.Builder(1010, serviceComponent)
                .setMinimumLatency(Integer.parseInt(com.newstoday.rssfeedreader.utils.PrefUtils.getString(com.newstoday.rssfeedreader.utils.PrefUtils.REFRESH_INTERVAL, SIXTY_MINUTES)))
                .setPersisted(true)
                .setRequiredNetworkType(JobInfo.NETWORK_TYPE_ANY)
                .build();
