 ...
 */
package com.newstoday.screenfilter.service;
...
public class MaskService extends Service {
    ...
    private void createNotification() {
        ...
        Notification.Action pauseAction = new Notification.Action(
                R.drawable.filter_wb_incandescent_black_24dp,
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT_WATCH) {
            builder = new Notification.Builder(getApplicationContext())
                    ...
                    .setSmallIcon(R.drawable.filter_brightness_2_black_48dp)
        ...
        mNotification = Objects.requireNonNull(builder).build();
    }
