 ...
 */
package com.newstoday.screenfilter.ui;
...
import com.newstoday.screenfilter.ui.adapter.ModeListAdapter;
import com.newstoday.screenfilter.ui.dialog.SchedulerDialog;
...
//        }
    ...
    private void updateSchedulerRow() {
        mSchedulerIcon.setImageResource(mSettings.isAutoMode() ?
                R.drawable.filter_alarm_black_24dp : R.drawable.filter_alarm_off_black_24dp);
    ...
    private void initAdvancedModeRow() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            settingsButton.setImageResource(R.drawable.filter_help_outline_black_24dp);
    ...
    private void setToggleIconState(boolean isRunning) {
        if (mToggle != null && !isFinishing()) {
            ...
            mToggle.setImageResource(isRunning ?
                    R.drawable.filter_brightness_2_black_24dp : R.drawable.filter_brightness_7_black_24dp);
        }
    }
