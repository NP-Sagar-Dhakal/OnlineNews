...
package com.newstoday.screenfilter;

public final class Constants {

    public static final String NOTIFICATION_CHANNEL_ID_RS = "running_status";

    public static final String ACTION_UPDATE_STATUS = "com.newstoday.screenfilter.ACTION_UPDATE_STATUS";
    public static final String ACTION_ALARM_START = "com.newstoday.screenfilter.ALARM_ACTION_START";
    public static final String ACTION_ALARM_STOP = "com.newstoday.screenfilter.ALARM_ACTION_STOP";
    public static final String ACTION_TOGGLE = "com.newstoday.screenfilter.ACTION_TOGGLE";
