...
public class PrefUtils {
    public static final String FIRST_OPEN = "FIRST_OPEN_L_TWENTYNINE";
    public static final String IS_REFRESHING = "IS_REFRESHING_L_TWENTYNINE";
    ...
    public static final String SHOW_READ = "show_read_l_twentynine";
