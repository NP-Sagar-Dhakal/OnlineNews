...
package com.newstoday.news_package.news_location.six.activity;
...
import com.newstoday.news_package.news_location.six.fragment.EntriesListFragment;
import com.newstoday.news_package.news_location.six.provider.FeedData;
import com.newstoday.news_package.news_location.six.provider.FeedData.EntryColumns;
import com.newstoday.news_package.news_location.six.provider.FeedData.FeedColumns;
import com.newstoday.news_package.news_location.six.provider.FeedDataContentProvider;
import com.newstoday.news_package.news_location.six.utils.PrefUtils;
...
public class HomeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.location_six_view_home);
        ...
        String url1 = MainHomeActivity.Location6RssLinks.get(i).rssLink1;
        String url2 = MainHomeActivity.Location6RssLinks.get(i).rssLink2;
        String url3 = MainHomeActivity.Location6RssLinks.get(i).rssLink3;
        String url4 = MainHomeActivity.Location6RssLinks.get(i).rssLink4;
        String url5 = MainHomeActivity.Location6RssLinks.get(i).rssLink5;
        String url6 = MainHomeActivity.Location6RssLinks.get(i).rssLink6;
        String url7 = MainHomeActivity.Location6RssLinks.get(i).rssLink7;
        String url8 = MainHomeActivity.Location6RssLinks.get(i).rssLink8;
        String url9 = MainHomeActivity.Location6RssLinks.get(i).rssLink9;
        String url10 = MainHomeActivity.Location6RssLinks.get(i).rssLink10;
        String url11 = MainHomeActivity.Location6RssLinks.get(i).rssLink11;
        String url12 = MainHomeActivity.Location6RssLinks.get(i).rssLink12;
        String url13 = MainHomeActivity.Location6RssLinks.get(i).rssLink13;
        String url14 = MainHomeActivity.Location6RssLinks.get(i).rssLink14;
        String url15 = MainHomeActivity.Location6RssLinks.get(i).rssLink15;
