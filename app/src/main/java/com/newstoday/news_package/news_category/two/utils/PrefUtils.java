...
public class PrefUtils {
    public static final String FIRST_OPEN = "FIRST_OPEN_CAT_TWO";
    public static final String IS_REFRESHING = "IS_REFRESHING_CAT_TWO";
    ...
    public static final String SHOW_READ = "show_read_c_two";
