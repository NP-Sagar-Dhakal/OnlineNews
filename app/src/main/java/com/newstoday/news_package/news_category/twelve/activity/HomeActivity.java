...
package com.newstoday.news_package.news_category.twelve.activity;
...
import com.newstoday.news_package.news_category.twelve.fragment.EntriesListFragment;
...
import com.newstoday.news_package.news_category.twelve.provider.FeedDataContentProvider;
...
public class HomeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_twelve_view_home);
        ...
        String url1 = MainHomeActivity.category12RssLinks.get(i).rssLink1;
        String url2 = MainHomeActivity.category12RssLinks.get(i).rssLink2;
        String url3 = MainHomeActivity.category12RssLinks.get(i).rssLink3;
        String url4 = MainHomeActivity.category12RssLinks.get(i).rssLink4;
        String url5 = MainHomeActivity.category12RssLinks.get(i).rssLink5;
        String url6 = MainHomeActivity.category12RssLinks.get(i).rssLink6;
        String url7 = MainHomeActivity.category12RssLinks.get(i).rssLink7;
        String url8 = MainHomeActivity.category12RssLinks.get(i).rssLink8;
        String url9 = MainHomeActivity.category12RssLinks.get(i).rssLink9;
        String url10 = MainHomeActivity.category12RssLinks.get(i).rssLink10;
        String url11 = MainHomeActivity.category12RssLinks.get(i).rssLink11;
        String url12 = MainHomeActivity.category12RssLinks.get(i).rssLink12;
        String url13 = MainHomeActivity.category12RssLinks.get(i).rssLink13;
        String url14 = MainHomeActivity.category12RssLinks.get(i).rssLink14;
        String url15 = MainHomeActivity.category12RssLinks.get(i).rssLink15;
